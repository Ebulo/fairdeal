(function () {
  ...
  var formSteps = [
    {
      eyebrow: "Step 1",
      title: "CMA (Complete Market Analysis)",
      description:
        "Lock the corridor, land size, unit, and legal-use status for the market analysis.",
    },
    {
      eyebrow: "Step 2",
    ...
    },
    {
      ...
      description:
        "Add the lead and institutional email where the Complete Market Analysis should be sent.",
    },
  ];
  ...
  var growthCorridors = [
    {
      ...
      riskScore: 12,
      maturity:
        "High demand technology corridor with strong services-led absorption.",
    },
    {
    ...
    },
    {
      ...
      riskScore: 20,
      maturity:
        "Industrial catchment with clear utility demand but uneven frontage quality.",
    },
    {
      ...
      riskScore: 22,
      maturity:
        "Mature commercial corridor with title-chain and access constraints.",
    },
    {
      ...
      riskScore: 34,
      maturity:
        "Premium tourism corridor with coastal and approvals sensitivity.",
    },
    {
    ...
    },
    {
      ...
      riskScore: 14,
      maturity:
        "High infrastructure maturity with airport and NH-linked demand.",
    },
    {
      ...
      riskScore: 24,
      maturity:
        "Industrial cluster with strong anchor demand and execution checks.",
    },
  ];
  ...
  var zoning = [
    {
      ...
      riskScore: 56,
      interpretation:
        "Agricultural status prices in conversion uncertainty and buyer eligibility review.",
    },
    {
      value: "na-pending",
      ...
      riskScore: 38,
      interpretation:
        "Conversion pathway exists, but timing and documentation remain diligence items.",
    },
    {
    ...
    },
    {
      ...
      riskScore: 8,
      interpretation:
        "Planning approval creates liquidity premium with limited title friction.",
    },
    {
      ...
      riskScore: 6,
      interpretation:
        "Registration and disclosure discipline reduce marketing and delivery ambiguity.",
    },
    {
      ...
      riskScore: 10,
      interpretation:
        "Industrial compatibility supports logistics absorption when access is verified.",
    },
    {
      ...
      riskScore: 48,
      interpretation:
        "Coastal premium is offset by approval, setback, and environmental diligence.",
    },
  ];
  ...
  var intents = [
    {
      ...
      riskScore: 16,
      interpretation:
        "Residential land has broad resale liquidity with moderate approval load.",
    },
    {
      ...
      riskScore: 24,
      interpretation:
        "Commercial frontage can outperform, but depends on access and parking viability.",
    },
    {
      ...
      riskScore: 22,
      interpretation:
        "Logistics intent captures corridor deficit and warehousing demand.",
    },
    {
      ...
      riskScore: 18,
      interpretation:
        "Impact use has steadier demand but lower speculative premium.",
    },
    {
      ...
      riskScore: 38,
      interpretation:
        "Agro-processing requires stricter use, access, and conversion checks.",
    },
    {
      ...
      riskScore: 28,
      interpretation:
        "Industrial end-use can justify premium if utilities and clearances are visible.",
    },
  ];
  ...
  var budgets = [
    ...
    {
      value: "75-lakh-1-5-cr",
      label: "Rs 75L - Rs 1.5Cr",
      min: 7500000,
      max: 15000000,
    },
    {
      value: "1-5-3-cr",
      label: "Rs 1.5Cr - Rs 3Cr",
      min: 15000000,
      max: 30000000,
    },
    {
      value: "3-10-cr",
      label: "Rs 3Cr - Rs 10Cr",
      min: 30000000,
      max: 100000000,
    },
  ...
  var timelines = [
    {
      ...
      riskScore: 26,
      interpretation:
        "Urgent acquisition creates scarcity premium but compresses diligence windows.",
    },
    {
      value: "short-term",
      ...
      riskScore: 18,
      interpretation:
        "Enough time for title screening while keeping price discovery current.",
    },
    {
      value: "medium-term",
      ...
      riskScore: 12,
      interpretation:
        "Balanced timeline with room for diligence and negotiation.",
    },
    {
      value: "planning",
      ...
      riskScore: 8,
      interpretation:
        "Longer horizon improves diligence but softens urgency premium.",
    },
  ];
  ...
  var profiles = [
    {
      ...
      riskScore: 14,
      interpretation:
        "Standard buyer profile with ordinary title and funding review.",
    },
    {
      ...
      riskScore: 32,
      interpretation:
        "Repatriation demand premium, offset by FEMA and banking-channel checks.",
    },
    {
      ...
      riskScore: 8,
      interpretation:
        "Lowest scrutiny tier with high ability to complete diligence.",
    },
    {
      ...
      riskScore: 10,
      interpretation:
        "Strong documentation behaviour and lower compliance friction.",
    },
    {
      ...
      riskScore: 34,
      interpretation:
        "Transaction scrutiny and documentation sensitivity increase review load.",
    },
    {
      value: "corporate-sme",
      label: "Corporate / SME",
      ...
      riskScore: 18,
      interpretation:
        "Entity purchase improves capital readiness but adds board/KYC process.",
    },
  ];
  ...
  function getBudgetFit(baseMarketValue, budget) {
    if (!budget.max) {
      return {
        ...
        description:
          "Selected budget supports institutional-size land options.",
      };
    }
    ...
    if (baseMarketValue <= budget.max) {
      return {
        ...
        description:
          "Indicative base value fits the selected acquisition band.",
      };
    }
    ...
    if (baseMarketValue <= budget.max * 1.18) {
      return {
        ...
        description:
          "Indicative value is close enough for negotiation or phased acquisition.",
      };
    }
    ...
    return {
      ...
      description:
        "Selected land thesis may require smaller area, lower-basis corridor, or higher budget.",
    };
  }

  function calculateCma(form) {
    var corridor = findOption(
      growthCorridors,
      form.growthCorridor,
      optionFallbacks.corridor,
    );
    var unit = findOption(units, form.unitOfMeasurement, optionFallbacks.unit);
    var zoningOption = findOption(
      zoning,
      form.zoningStatus,
      optionFallbacks.zoning,
    );
    var intent = findOption(
      intents,
      form.developmentIntent,
      optionFallbacks.intent,
    );
    var budget = findOption(
      budgets,
      form.investmentBudgetRange,
      optionFallbacks.budget,
    );
    var timeline = findOption(
      timelines,
      form.acquisitionTimeline,
      optionFallbacks.timeline,
    );
    var profile = findOption(
      profiles,
      form.investorProfile,
      optionFallbacks.profile,
    );
    var areaInput = Number.parseFloat(form.plotArea);
    var normalizedAreaInput =
      Number.isFinite(areaInput) && areaInput > 0 ? areaInput : 0;
    var areaSqft = normalizedAreaInput * unit.factor;
    var baseMarketValue =
      areaSqft * corridor.baseRate * zoningOption.multiplier;
    var rawCagr =
      corridor.baseGrowth +
      intent.cagrModifier +
    ...
    return {
      ...
      totalGainPercent:
        baseMarketValue > 0 ? (absoluteGain / baseMarketValue) * 100 : 0,
      rawCagr: rawCagr,
  ...
  function formatPercent(value, maximumFractionDigits) {
    return (
      (value >= 0 ? "+" : "") + value.toFixed(maximumFractionDigits || 1) + "%"
    );
  }
  ...
  function getFormState(form) {
    ...
    return {
      ...
      investmentBudgetRange: String(
        formData.get("investmentBudgetRange") || "",
      ),
  ...
  function validateStep(form, stepIndex) {
    ...
    if (stepIndex === 0) {
      if (!state.growthCorridor)
        errors.push("Select a growth corridor or locality.");
      if (!state.plotArea) errors.push("Add the plot area.");
      if (!state.unitOfMeasurement)
        errors.push("Select a unit of measurement.");
      if (!state.zoningStatus)
        errors.push("Select the zoning and title status.");
      if (state.plotArea) {
        var area = Number.parseFloat(state.plotArea);
        if (!Number.isFinite(area) || area <= 0)
          errors.push("Enter a plot area greater than zero.");
        if (area > 1000000)
          errors.push("Enter a realistic plot area for this report.");
      }
    }

    if (stepIndex === 1) {
      if (!state.developmentIntent) errors.push("Select a development intent.");
      if (!state.investmentBudgetRange)
        errors.push("Select an investment budget range.");
      if (!state.acquisitionTimeline)
        errors.push("Select a target acquisition timeline.");
    ...
    if (stepIndex === 2) {
      ...
      if (!isValidPhone(state.mobileNumber))
        errors.push("Add a valid mobile number.");
      if (!isValidEmail(state.emailAddress))
        errors.push("Add a valid email address.");
      if (!isValidEmail(state.institutionalEmail))
        errors.push("Add a valid institutional email.");
    }
  ...
  function validateCmaForm(form) {
    var state = getFormState(form);
    var errors = validateStep(form, 0).concat(
      validateStep(form, 1),
      validateStep(form, 2),
    );
    ...
    var invalidSelections = [
      ...
      state.investmentBudgetRange &&
        !hasOption(budgets, state.investmentBudgetRange),
      state.acquisitionTimeline &&
        !hasOption(timelines, state.acquisitionTimeline),
  ...
  function populateSelects(form) {
    Array.prototype.forEach.call(
      form.querySelectorAll("[data-fd-cma-options]"),
      function (select) {
  ...
  function renderForm(state) {
    ...
    var progress = state.hasResponse
      ? 100
      : ((state.activeStep + 1) / formSteps.length) * 100;

    setText(
      form,
      "[data-fd-cma-kicker]",
      state.hasResponse ? "Response ready" : currentStep.eyebrow,
    );
    setText(
      form,
      "[data-fd-cma-title]",
      state.hasResponse ? "Complete Market Analysis generated" : currentStep.title,
    );
    setText(
      form,
      "[data-fd-cma-description]",
      state.hasResponse
        ? "A few headline details are shown below. The Complete Market Analysis has been sent to the delivery workflow."
    ...
    setText(
      ...
      state.hasResponse
        ? "Complete"
        : state.activeStep + 1 + " / " + formSteps.length,
    );
    ...
    Array.prototype.forEach.call(
      form.querySelectorAll("[data-fd-cma-tab]"),
      function (tab) {
    ...
    Array.prototype.forEach.call(
      form.querySelectorAll("[data-fd-cma-step]"),
      function (step) {
    ...
    if (nextButton)
      nextButton.hidden =
        state.hasResponse || state.activeStep >= formSteps.length - 1;

    if (submitButton) {
      submitButton.hidden =
        state.hasResponse || state.activeStep !== formSteps.length - 1;
      submitButton.disabled = state.isSubmitting;
      submitButton.textContent = state.isSubmitting
        ? "Generating..."
  ...
  function renderResult(form, calculation, deliveryMessage) {
    ...
    setText(
      form,
      "[data-fd-cma-delivery]",
      deliveryMessage || "PDF queued for " + state.emailAddress,
    );
    setText(
      form,
      "[data-fd-cma-base]",
      formatCurrencyCompact(calculation.baseMarketValue),
    );
    setText(
      form,
      "[data-fd-cma-area]",
      formatNumber(calculation.areaSqft) + " sq.ft. analysed",
    );
    setText(
      form,
      "[data-fd-cma-projected]",
      formatCurrencyCompact(calculation.projectedValue),
    );
    setText(
      form,
      "[data-fd-cma-cagr]",
      "At " + formatPercent(calculation.blendedCagr) + " p.a. blended CAGR",
    );
    setText(form, "[data-fd-cma-risk]", calculation.riskIndex + " / 100");
    setText(
      form,
      "[data-fd-cma-risk-band]",
      calculation.riskBand.label + " - " + calculation.riskBand.description,
    );
  }
  ...
  function initCmaForm() {
    ...
    form.addEventListener("submit", function (event) {
      ...
      showMessage(
        form,
        "Generating the Complete Market Analysis and sending it to the delivery workflow.",
      );
      renderForm(state);
      ...
      submitToDeliveryWorkflow(form, calculation)
        .then(function () {
          ...
          renderResult(
            form,
            calculation,
            "PDF delivery queued for " + getFormState(form).emailAddress,
          );
          showMessage(
            form,
            "The Complete Market Analysis is ready and the delivery workflow has been triggered.",
            "success",
          );
          renderForm(state);
          focusForm();
        ...
        .catch(function () {
          ...
          renderResult(
            form,
            calculation,
            "Local Complete Market Analysis generated for " +
              getFormState(form).emailAddress,
          );
          showMessage(
            form,
            "The local Complete Market Analysis is ready, but email delivery could not be confirmed. Please try again or contact Fairdeal.",
            "error",
          );
          renderForm(state);
          focusForm();
  ...
  function initRegulatoryCards() {
    Array.prototype.forEach.call(
      document.querySelectorAll("[data-fd-regulatory-card]"),
      function (card) {
        function toggleCard() {
          ...
          if (
            ...
            label.indexOf("Collapse") === 0
          ) {
            card.setAttribute(
              "aria-label",
              label.replace(
                isFlipped ? "Expand" : "Collapse",
                isFlipped ? "Collapse" : "Expand",
              ),
            );
          }
        }
